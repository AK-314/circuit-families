...
| ----- | ----- | ----- |
| Primary fidelity threshold | Stage 11 | Pilot post-grokking sparse circuit, random masks, Fourier diagnostic and computational feasibility only |
| Full or reduced scaled checkpoint grid | After Stage 12 compute projection | Prospective compute projection only |
| Selected no-generalisation fraction | Stage 13 | Training and test curves only |
| Additional control-seed count | Stage 18 | Available resources, following the frozen priority order |
